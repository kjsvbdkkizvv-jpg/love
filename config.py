...
PRIMARY_COLOR = discord.Color.from_str("#FD91E2")  # hot pink
...
CHANNEL_MATCH_REPORTS = int(os.getenv("CHANNEL_MATCH_REPORTS", "1544063102830780498"))
CHANNEL_STAFF_PROFILE_REVIEW = int(os.getenv("CHANNEL_STAFF_PROFILE_REVIEW", "1544865137607970928"))
